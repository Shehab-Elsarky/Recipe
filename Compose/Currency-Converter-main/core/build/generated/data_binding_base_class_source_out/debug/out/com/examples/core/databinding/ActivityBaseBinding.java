...
public final class ActivityBaseBinding implements ViewBinding {
  ...
  private ActivityBaseBinding(@NonNull ConstraintLayout rootView, @NonNull Toolbar toolbarBase,
  ...
  public static ActivityBaseBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.toolbarBase;
      Toolbar toolbarBase = rootView.findViewById(id);
      if (toolbarBase == null) {
        break missingId;
      }
      ...
      return new ActivityBaseBinding((ConstraintLayout) rootView, toolbarBase, tvTitle);
    }
