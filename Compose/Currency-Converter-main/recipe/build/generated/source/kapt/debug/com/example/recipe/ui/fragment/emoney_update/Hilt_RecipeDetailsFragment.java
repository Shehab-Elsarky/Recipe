...
public abstract class Hilt_RecipeDetailsFragment<VB extends ViewBinding, VM extends BaseViewModel, HelperClass extends BaseUiHelper> extends BaseFragment<VB, VM, HelperClass> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecipeDetailsFragment_GeneratedInjector) this.generatedComponent()).injectRecipeDetailsFragment(UnsafeCasts.<RecipeDetailsFragment>unsafeCast(this));
    }
  }
