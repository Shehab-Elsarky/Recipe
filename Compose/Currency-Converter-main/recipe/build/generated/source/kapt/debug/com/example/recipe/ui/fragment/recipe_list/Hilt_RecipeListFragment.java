...
public abstract class Hilt_RecipeListFragment<VB extends ViewBinding, VM extends BaseViewModel, HelperClass extends BaseUiHelper> extends BaseFragment<VB, VM, HelperClass> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecipeListFragment_GeneratedInjector) this.generatedComponent()).injectRecipeListFragment(UnsafeCasts.<RecipeListFragment>unsafeCast(this));
    }
  }
